...
import dev.dudie.baritonehelper.internal.baritone.api.utils.TypeUtils;
...
public final class Settings {
   ...
   public final Settings.Setting<TagKey<Block>> okIfAir = new Settings.Setting<>(
      TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(InternalBaritoneRuntime.MOD_ID, "build/ok_if_air"))
   );
   ...
   public final Settings.Setting<Consumer<Component>> logger = new Settings.Setting<>(message -> InternalBaritoneRuntime.LOGGER.info(message.getString()));
