...
import dev.dudie.baritonehelper.internal.baritone.pathing.calc.openset.BinaryHeapOpenSet;
import dev.dudie.baritonehelper.internal.baritone.pathing.movement.CalculationContext;
import dev.dudie.baritonehelper.internal.baritone.pathing.movement.Moves;
import dev.dudie.baritonehelper.internal.baritone.utils.pathing.BetterWorldBorder;
import dev.dudie.baritonehelper.internal.baritone.utils.pathing.Favoring;
...
public final class AStarPathFinder extends AbstractNodeCostSearch {
   ...
   protected Optional<IPath> calculate0(long primaryTimeout, long failureTimeout) {
      ...
      if (this.cancelRequested) {
         ...
         InternalBaritoneRuntime.LOGGER.debug("Open set size: " + openSet.size());
         InternalBaritoneRuntime.LOGGER.debug("PathNode map size: " + this.mapSize());
         InternalBaritoneRuntime.LOGGER.debug((int)(numNodes * 1.0 / ((float)(System.currentTimeMillis() - startTime) / 1000.0F)) + " nodes per second");
