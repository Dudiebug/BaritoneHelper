...
public final class LookBehavior extends Behavior implements ILookBehavior {
   ...
   private Rotation getActualTarget(@Nullable Rotation primaryTarget, @Nullable Rotation secondaryTarget) {
      if (this.baritone.settings().freeLook.get()) {
         updateControlsToMatch((dev.dudie.baritonehelper.internal.baritone.utils.InputOverrideHandler)this.baritone.getInputOverrideHandler(), primaryTarget, this.ctx.entity().getYRot());
         return null;
      } else if (secondaryTarget != null) {
         updateControlsToMatch((dev.dudie.baritonehelper.internal.baritone.utils.InputOverrideHandler)this.baritone.getInputOverrideHandler(), primaryTarget, secondaryTarget.getYaw());
