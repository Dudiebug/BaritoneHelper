...
import dev.dudie.baritonehelper.internal.baritone.api.pathing.goals.GoalGetToBlock;
      ...
      if (this.knownLocations.isEmpty()) {
         ...
         if (calcFailed) {
            ...
            if (mineGoalUpdateInterval != 0 && this.tickCount++ % mineGoalUpdateInterval == 0) {
               ...
               InternalBaritoneRuntime.getExecutor().execute(() -> this.rescan(current, context));
            }
